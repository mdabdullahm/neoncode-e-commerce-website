    ...
    <main className="min-h-screen bg-gradient-to-r from-[#5BF527] to-[#C1F863] flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
           ...
           <a 
             href="https://neoncode.co" 
             target="_blank" 
             rel="noopener noreferrer"
             className="w-full sm:w-auto bg-white text-black border-2 border-gray-100 px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-3 hover:border-[#5BF527] transition-all active:scale-95 group"
           >
              <Globe size={18} className="group-hover:text-[#5BF527]" /> Visit NeonCode <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
           </a>
        </div>
